...
<%
    ...
    request.getSession().setAttribute("page", "phu_kien.jsp");
%>
<!DOCTYPE html>
<html lang="vn">
    <head>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-xs-12 right-item pull-right">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="box-tt">
                                            <h2 class="title_h1">Phụ Kiện Nam</h2>
                                        </div>
                                        <input type="hidden" id="loai" value="20">
                                        <div class="product-item" id="danhsachsanpham">
                                            <%
                                                Vector<Product> getProducts = new Data().getProducts(0, "", "", "", 0, 20, 18);
