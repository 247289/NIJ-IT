...
<%
    ...
    request.getSession().setAttribute("page", "quan_nam.jsp");
%>
<!DOCTYPE html>
<html lang="vn">
    <head>
    ...
    <body>
        <input type="hidden" id="loai" value="-1">
        <div class="content">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-xs-12 right-item pull-right">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="box-tt">
                                            <h2 class="title_h1">Quần Nam</h2>
                                        </div>
                                        <div class="product-item" id="danhsachsanpham">
                                            <%
                                                Vector<Product> getProducts = new Data().getProducts(0, "", "", "", 0, 15, 6);
                                        ...
                                        <!--</div>-->
                                                <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_1 = new Data().getProduct_1(0, "", "", "", 0, 16, 6);
                                        ...
                                        <!--</div>-->
                                                <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_2 = new Data().getProduct_2(0, "", "", "", 0, 17, 6);
                                        ...
                                        <!--</div>-->
                                                <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_3 = new Data().getProduct_3(0, "", "", "", 0, 18, 6);
