...
<%
    ...
    request.getSession().setAttribute("page", "ao_nam.jsp");
%>
<!DOCTYPE html>
<html lang="vn">
    <head>
    ...
    <body>
        <input type="hidden" id="loai" value="0">
        <div class="content">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-xs-12 right-item pull-right">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="box-tt">
                                            <h2 class="title_h1">Áo Nam</h2>
                                        </div>
                                        <div class="product-item" id="danhsachsanpham">
                                            <%                                                Vector<Product> getProducts = new Data().getProducts(0, "", "", "", 0, 2, 6);
                                                ...
                                                <div class="col-md-4 col-xs-6">
                                                    <div class="product">
                                                        ...
                                                        <div class="product-btn">
                                                            ...
                                                            <a onclick="addToCart(<%=t.getMaSP()%>)" title="Thêm vào gi? hàng" class="btn btn-default"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div><!--end col-md-4-->
                                        ...
                                        <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_1 = new Data().getProduct_1(0, "", "", "", 0, 3, 6);
                                            ...
                                            %> 
                                            <div class="row">
                                                <% a = getProduct_1.get(i);%>
                                                <div class="col-md-4 col-xs-6">
                                                    <div class="product">
                                                        <a class="img" href="chi_tiet_san_pham.jsp?masp=<%=a.getMaSP()%>" title="#"><img class="img-responsive" src="<%=a.getHinhAnh().split(";")[0]%>" alt="#"></a>
                                                        <figcaption><h2><a href="chi_tiet_san_pham.jsp?masp=<%=a.getMaSP()%>" title="#"><%=a.getTenSP()%></a></h2>
                                                            <div class="call"><%=a.getMaSP()%></div>
                                                            <div class="price"><%=a.getGia()%>VND</div>
                                                        </figcaption>
                                                        <div class="product-btn">
                                                            <a href="chi_tiet_san_pham.jsp?masp=<%=a.getMaSP()%>" title="Mua ngay" class="btn btn-default">Mua ngay</a>
                                                            <a onclick="addToCart(<%=t.getMaSP()%>)" title="Thêm vào gi? hàng" class="btn btn-default"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div><!--end col-md-4-->
                                                <% if (i == getProduct_1.size() - 1) {
                                                %>
                                                <div class="col-md-4 col-xs-6">
                                        ...
                                        <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_2 = new Data().getProduct_2(0, "", "", "", 0, 13, 6);
                                            ...
                                            %> 
                                            <div class="row">
                                                <% a2 = getProduct_2.get(i);%>
                                                <div class="col-md-4 col-xs-6">
                                                    <div class="product">
                                                        <a class="img" href="chi_tiet_san_pham.jsp?masp=<%=a2.getMaSP()%>" title="#"><img class="img-responsive" src="<%=a2.getHinhAnh().split(";")[0]%>" alt="#"></a>
                                                        <figcaption><h2><a href="chi_tiet_san_pham.jsp?masp=<%=a2.getMaSP()%>" title="#"><%=a2.getTenSP()%></a></h2>
                                                            <div class="call"><%=a2.getMaSP()%></div>
                                                            <div class="price"><%=a2.getGia()%>VND</div>
                                                        </figcaption>
                                                        <div class="product-btn">
                                                            <a href="chi_tiet_san_pham.jsp?masp=<%=a2.getMaSP()%>" title="Mua ngay" class="btn btn-default">Mua ngay</a>
                                                            <a onclick="addToCart(<%=t.getMaSP()%>)" title="Thêm vào gi? hàng" class="btn btn-default"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div><!--end col-md-4-->
                                                <% if (i == getProduct_2.size() - 1) {
                                                %>
                                                <div class="col-md-4 col-xs-6">
                                        ...
                                        <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_3 = new Data().getProduct_3(0, "", "", "", 0, 1, 6);
                                            ...
                                            %> 
                                            <div class="row">
                                                <% a3 = getProduct_3.get(i);%>
                                                <div class="col-md-4 col-xs-6">
                                                    <div class="product">
                                                        <a class="img" href="chi_tiet_san_pham.jsp?masp=<%=a3.getMaSP()%>" title="#"><img class="img-responsive" src="<%=a3.getHinhAnh().split(";")[0]%>" alt="#"></a>
                                                        <figcaption><h2><a href="chi_tiet_san_pham.jsp?masp=<%=a3.getMaSP()%>" title="#"><%=a3.getTenSP()%></a></h2>
                                                            <div class="call"><%=a3.getMaSP()%></div>
                                                            <div class="price"><%=a3.getGia()%>VND</div>
                                                        </figcaption>
                                                        <div class="product-btn">
                                                            <a href="chi_tiet_san_pham.jsp?masp=<%=a3.getMaSP()%>" title="Mua ngay" class="btn btn-default">Mua ngay</a>
                                                            <a onclick="addToCart(<%=t.getMaSP()%>)" title="Thêm vào gi? hàng" class="btn btn-default"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div><!--end col-md-4-->
                                                <% if (i == getProduct_3.size() - 1) {
                                                %>
                                                <div class="col-md-4 col-xs-6">
                                        ...
                                        <!--<div class="product-item" id="danhsachsanpham">-->
                                            <%
                                                Vector<Product> getProduct_4 = new Data().getProduct_4(0, "", "", "", 0, 14, 6);
                                            ...
                                            %> 
                                            <div class="row">
                                                <% a4 = getProduct_4.get(i);%>
                                                <div class="col-md-4 col-xs-6">
                                                    <div class="product">
                                                        <a class="img" href="chi_tiet_san_pham.jsp?masp=<%=a4.getMaSP()%>" title="#"><img class="img-responsive" src="<%=a4.getHinhAnh().split(";")[0]%>" alt="#"></a>
                                                        <figcaption><h2><a href="chi_tiet_san_pham.jsp?masp=<%=a4.getMaSP()%>" title="#"><%=a4.getTenSP()%></a></h2>
                                                            <div class="call"><%=a4.getMaSP()%></div>
                                                            <div class="price"><%=a4.getGia()%>VND</div>
                                                        </figcaption>
                                                        <div class="product-btn">
                                                            <a href="chi_tiet_san_pham.jsp?masp=<%=a4.getMaSP()%>" title="Mua ngay" class="btn btn-default">Mua ngay</a>
                                                            <a onclick="addToCart(<%=t.getMaSP()%>)" title="Thêm vào gi? hàng" class="btn btn-default"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div><!--end col-md-4-->
                                                <% if (i == getProduct_4.size() - 1) {
                                                %>
                                                <div class="col-md-4 col-xs-6">
