...
<%
    ...
    request.getSession().setAttribute("page", "ao_so_mi_nam.jsp");
%>
<!DOCTYPE html>
<html lang="vn">
    <head>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-xs-12 right-item pull-right">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="box-tt">
                                            <h2 class="title_h1">Áo sơ mi nam</h2>
                                        </div>
                                        <input type="hidden" id="loai" value="3">
                                        <div class="product-item" id="danhsachsanpham">
                                            <%
                                                Vector<Product> getProducts = new Data().getProducts(0, "", "", "", 0, 3, 9);
