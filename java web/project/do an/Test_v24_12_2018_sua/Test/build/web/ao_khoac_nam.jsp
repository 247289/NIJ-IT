...
<%
    ...
    request.getSession().setAttribute("page", "ao_khoac_nam.jsp");
%>
<!DOCTYPE html>
<html lang="vn">
    <head>
    ...
    <body>
        <input type="hidden" id="loai" value="13">
        <div class="content">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-xs-12 right-item pull-right">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="box-tt">
                                            <h2 class="title_h1">Áo Khoác Nam</h2>
                                        </div>
                                        <div class="product-item" id="danhsachsanpham">
                                            <%
                                                Vector<Product> getProducts = new Data().getProducts(0, "", "", "", 0, 13, 9);
