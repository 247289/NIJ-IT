...
public class DataKH {
    ...
    public static String insertComsumer(String hoten, String diachi, String sdt, String email, String matkhau, String gioitinh) {
        String sql = "insert into khachhang(hoten,diachi,dienthoai,email,matkhau,gioitinh,diemso) values(\'" + hoten + "\',\'" + diachi + "\',\'" + sdt + "\',\'" + email + "\',\'" + matkhau + "\'," + gioitinh + ",0)";
        Connection con = null;
        Statement state = null;
        try {
            con = new DataAccess().getConnect();
    ...
    public static Comsumer checkLogin(String user, String pass) {
        String sql = "select * from khachhang where (dienthoai=\'" + user + "\' or email=\'"+user+"\') and matkhau=\'" + pass + "\'";
        Connection con = null;
        Statement state = null;
        ResultSet rs = null;
        Comsumer e = null;
        try {
            ...
            rs = state.executeQuery(sql);
            while (rs.next()) {
                e=DataKH.getKH(rs.getString("makh"));
            }
        } catch (Exception e1) {
            e1.printStackTrace();
        } finally {
