...
public class Data {
    ...
    public Vector<Product> getProducts(int ma, String name, String kichCo, String mau, int ncc, int loai, int limit) {
    ...
    public Vector<Product> getProduct_1(int ma, String name, String kichCo, String mau, int ncc, int loai, int limit) {
        Vector<Product> products = new Vector<Product>();
        String sql = "select p.*, n.tennhacungcap name,t.tenloai tl from sanpham p,nhacungcap n,loaisanpham t where p.manhacungcap=n.manhacungcap and p.maloaisp=t.maloaisp";
        if (ma > 0) {
            sql += " and p.masp=" + ma;
    ...
    public Vector<Product> getProduct_2(int ma, String name, String kichCo, String mau, int ncc, int loai, int limit) {
        Vector<Product> products = new Vector<Product>();
        String sql = "select p.*, n.tennhacungcap name,t.tenloai tl from sanpham p,nhacungcap n,loaisanpham t where p.manhacungcap=n.manhacungcap and p.maloaisp=t.maloaisp";
        if (ma > 0) {
            sql += " and p.masp=" + ma;
    ...
    public Vector<Product> getProduct_3(int ma, String name, String kichCo, String mau, int ncc, int loai, int limit) {
        Vector<Product> products = new Vector<Product>();
        String sql = "select p.*, n.tennhacungcap name,t.tenloai tl from sanpham p,nhacungcap n,loaisanpham t where p.manhacungcap=n.manhacungcap and p.maloaisp=t.maloaisp";
        if (ma > 0) {
            sql += " and p.masp=" + ma;
    ...
    public Vector<Product> getProduct_4(int ma, String name, String kichCo, String mau, int ncc, int loai, int limit) {
        Vector<Product> products = new Vector<Product>();
        String sql = "select p.*, n.tennhacungcap name,t.tenloai tl from sanpham p,nhacungcap n,loaisanpham t where p.manhacungcap=n.manhacungcap and p.maloaisp=t.maloaisp";
        if (ma > 0) {
            sql += " and p.masp=" + ma;
    ...
    public Vector<Product> getProduct_5(int ma, String name, String kichCo, String mau, int ncc, int loai, int limit) {
        Vector<Product> products = new Vector<Product>();
        String sql = "select p.*, n.tennhacungcap name,t.tenloai tl from sanpham p,nhacungcap n,loaisanpham t where p.manhacungcap=n.manhacungcap and p.maloaisp=t.maloaisp";
        if (ma > 0) {
            sql += " and p.masp=" + ma;
    ...
    public Vector<Product> getProduct(int ma, String name, String kichCo, String mau, int ncc, int loai) {
        Vector<Product> products = new Vector<Product>();
        String sql = "select p.*, n.tennhacungcap name,t.tenloai tl from sanpham p,nhacungcap n,loaisanpham t where p.manhacungcap=n.manhacungcap and p.maloaisp=t.maloaisp";
        if (ma > 0) {
            sql += " and p.masp=" + ma;
