<%-- 
    Document   : TinNoiBat
    Created on : Dec 14, 2018, 9:56:40 PM
    Author     : Admin
--%>
...
<body>
    <div class="wrapper">
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        <li><a href="index.jsp">Trang Chủ</a></li><li><a href="TinTuc.jsp">Tin Tức</a></li>
                        <li class="active"><a href="TinNoiBat.jsp">Tin Nổi Bật</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
        ...
        <div class="single-blog ptb-30  ptb-sm-60">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <aside>
                            <div class="single-sidebar latest-pro mb-30">
                                <h3 class="sidebar-title">Mới Ra Mắt</h3>
                            ...
                            <div class="col-img mb-30">
                                <a href="SanPhamServletDm"><img src="img/banner/banner-sidebar.jpg" alt="slider-banner"></a>
                            </div>
                            <div class="single-sidebar mb-30">
                                 <h3 class="sidebar-title">Khác</h3>
                                 <ul class="sidbar-style">
                                     <li><a href="SanPhamServletDm">Sản Phẩm Nổi Bật</a></li>
                                     <li><a href="SanPhamServletDm">Sản Phẩm Khuyến Mại</a></li>
                                     <li><a href="SanPhamServletDm">Sản Phẩm Mới</a></li>
                                 </ul>
                            </div>
                            <div class="tags">
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="single-sidebar-desc mb-all-40">
                            ...
                            <div class="sidebar-post-content">
                                <h3 class="sidebar-lg-title">APPLE RA MẮT IP-X</h3>
                                <ul class="post-meta d-sm-inline-flex">
                                    <li><span> 11/09/2018</span></li>
                                </ul>
                            </div>
                            ...
                            <div class="blog-detail-contact">
                                <h3 class="mb-15 leave-reply">Để Lại Bình Luận</h3>
